...
# Debrief Finalization — Steps 17, 22, 23, and 24

Companion file for dev-debrief SKILL.md. Contains mechanical finalization steps that run during full debrief. Read at two points: Step 17 (before Step 18), and Steps 22-24 (after Step 19). Step 18 (active-phase.md rewrite) is handled inline in SKILL.md.
