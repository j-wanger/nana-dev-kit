# Demand-Evidence Table — ceremony dispatches, Phases 76–85 (frozen corpus)

Verdict basis: re-execution-log.md entries (orchestrator-executed) + the pinned
downgrade rule. Candidates sourced from agent prose are NOT verdict evidence.

| id | session | date | step | label | evidence-class | reexec | caveat |
|---|---|---|---|---|---|---|---|
...
| d7 | 4548dee3-a069-4a70-a7fa-a801b78727a2.jsonl | 2026-06-10 | dev-plan-orchestration | Dev-plan artifact writer | zero-catch | - | agent-counterfactual residual applies |
| d8 | 4548dee3-a069-4a70-a7fa-a801b78727a2.jsonl | 2026-06-10 | review-gate-reviewer | Phase 84 review gate | ambiguous-downgrade | - | pre-fix recoverable via transcript-extraction; not re-executed (budget); candidate: 4 MEDIUM findings (Ph84) |
| d9 | 4548dee3-a069-4a70-a7fa-a801b78727a2.jsonl | 2026-06-10 | debrief-capture | Dev-wiki debrief executor | consumption-grade-capped | - | re-presentation class: cannot support keep; [uses:N] seeded at 1, increment discipline unknown |
| d10 | 4d08872a-5a96-4b15-98ed-21e2d7aff19d.jsonl | 2026-06-04 | spec-generation | Adversarial constraints for spec | ambiguous-downgrade | - | pre-fix unrecoverable (folded before commit); pinned downgrade; candidate: anti-retrofit ordering hazard pinned (Ph77) |
| d11 | 4d08872a-5a96-4b15-98ed-21e2d7aff19d.jsonl | 2026-06-04 | spec-generation | Tier 1 spec review | zero-catch | - | agent-counterfactual residual applies |
| d12 | 4d08872a-5a96-4b15-98ed-21e2d7aff19d.jsonl | 2026-06-04 | dev-plan-orchestration | Dev-plan artifact writer | zero-catch | - | agent-counterfactual residual applies |
| d13 | 4d08872a-5a96-4b15-98ed-21e2d7aff19d.jsonl | 2026-06-04 | debrief-capture | Dev-wiki debrief executor | consumption-grade-capped | - | re-presentation class: cannot support keep; [uses:N] seeded at 1, increment discipline unknown |
| d14 | 4d08872a-5a96-4b15-98ed-21e2d7aff19d.jsonl | 2026-06-04 | review-gate-reviewer | Phase 77 review gate | zero-catch | - | agent-counterfactual residual applies |
...
| d22 | 74a6533b-66aa-426d-9da0-b2a6d22a0197.jsonl | 2026-06-10 | review-gate-reviewer | Phase 85 review gate | outcome-grade-admitted | re-execution-log.md#r-ph85-review-gate | agent-counterfactual residual; audit DRIFT verdict environment-coupled |
...
| d35 | b9587f39-7dbc-425e-a8b6-362a81c96a28.jsonl | 2026-06-10 | debrief-capture | Dev-wiki debrief executor | consumption-grade-capped | - | re-presentation class: cannot support keep; [uses:N] seeded at 1, increment discipline unknown |
| d36 | bf3fdb28-1af9-4882-a1f5-636ee6f4925d.jsonl | 2026-06-09 | dev-plan-orchestration | Dev-plan state loader | zero-catch | - | agent-counterfactual residual applies |
| d37 | bf3fdb28-1af9-4882-a1f5-636ee6f4925d.jsonl | 2026-06-09 | spec-generation | Adversarial constraint generation | zero-catch | - | agent-counterfactual residual applies |
| d38 | bf3fdb28-1af9-4882-a1f5-636ee6f4925d.jsonl | 2026-06-09 | spec-generation | Spec Tier-1 semantic review | zero-catch | - | agent-counterfactual residual applies |
| d39 | bf3fdb28-1af9-4882-a1f5-636ee6f4925d.jsonl | 2026-06-09 | approach-reviewer | Approach reviewer (Step 12) | zero-catch | - | agent-counterfactual residual applies |
| d40 | bf3fdb28-1af9-4882-a1f5-636ee6f4925d.jsonl | 2026-06-09 | plan-reviewer | Plan reviewer (Step 14) | zero-catch | - | agent-counterfactual residual applies |
| d41 | bf3fdb28-1af9-4882-a1f5-636ee6f4925d.jsonl | 2026-06-09 | dev-plan-orchestration | Dev-plan artifact writer | zero-catch | - | agent-counterfactual residual applies |
| d42 | bf3fdb28-1af9-4882-a1f5-636ee6f4925d.jsonl | 2026-06-09 | debrief-capture | Dev-wiki debrief executor | consumption-grade-capped | - | re-presentation class: cannot support keep; [uses:N] seeded at 1, increment discipline unknown |
| d43 | e2e6d848-3ecc-4f5d-b550-3fe971f2065c.jsonl | 2026-06-09 | approach-reviewer | Approach reviewer for Phase 80 | ambiguous-downgrade | - | pre-fix unrecoverable (folded before commit); pinned downgrade; candidate: 4 CRITICAL design flaws folded (Ph80) |
| d44 | e2e6d848-3ecc-4f5d-b550-3fe971f2065c.jsonl | 2026-06-09 | debrief-capture | Dev-wiki debrief executor | consumption-grade-capped | - | re-presentation class: cannot support keep; [uses:N] seeded at 1, increment discipline unknown |

## Table-level caveats

- KNOWN UNDER-ENUMERATION: review-gate dispatches for Phases 81/82/83 are
  journal-narrated but absent from the manifest (their sessions fall outside the
  first-timestamp window or used unmatched labels). The review-gate denominator
  (3) undercounts by up to 3. The anchor control covers Phase 85 only.
- MDE guard (pre-registration ## MDE): review-gate-reviewer has 1 admitted event
  / 3 enumerated dispatches — BELOW the 3-event floor: zero/low counts for
  reviewer steps are statistically uninformative; cut requires expected-cost
  arithmetic, never the zero alone.
